...
export function OtherForm() {
  ...
  async function onSubmit(values: z.infer<typeof formSchema>) {
    ...
    try {
      ...
      if (data) {
        localStorage.setItem("managers", values.managers)
  ...
  return (
    <Form {...form}>
      <form
        ...
        className="space-y-6 w-[60rem]"
      >
        <h1 className="font-bold text-2xl">
          {" "}
          Personal Information <span className="text-red-700 text-2xl">*</span>
        </h1>
              ...
              <FormItem>
                ...
                <FormControl>
                  <Input
                    ...
                    type="email"
                    required
                    placeholder="sammynon@email.com"
                    {...field}
                  />
                </FormControl>
                <FormMessage />
        ...
        <h1 className="font-bold text-2xl">
          {" "}
          Other informations <span className="text-red-700 text-2xl">*</span>
        </h1>
              ...
              <Select onValueChange={field.onChange} defaultValue={field.value}>
                ...
                <SelectContent className="bg-amber-950 ">
                  <SelectItem value="ali">
                    ...
                    <h1 className="text-md font-semibold text-pretty">
                      Dr. Ali Shank
                    </h1>
                  </SelectItem>
          ...
          render={({ field }) => (
            <FormItem>
              ...
              <FormControl>
                <Input
                  disabled={isLoading}
                  placeholder=" NIN, Work id, Drivers Lincense, Passport, School ID "
                  {...field}
                />
              </FormControl>
              <FormMessage />
        ...
        <FormField
          ...
          render={({ field }) => (
            <FormItem>
              <FormLabel>
                NIN, Work id, Drivers Lincense, Passport, School ID
              </FormLabel>
              <FormControl>
                <div>
                  <Input
        ...
        <Button
          disabled={isLoading}
          className="bg-sky-700 w-full font-semibold cursor-pointer"
          type="submit"
        >
          {isLoading && (
            <div>
